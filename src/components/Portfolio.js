...
const projects = [
  ...
  {
    name: "Scroll-Reveal",
    description: `Proyecto de scroll reveal. Desarrollado con Bootstrap y jQuery, este proyecto utiliza efectos de desplazamiento para revelar de manera atractiva los detalles más importantes de la UCL.`,
    image: project2,
